...
public class PlanetController {
    ...
    public PlanetController(PlanetProvider planetProvider, PlanetService planetService,
        JwtService jwtService, PlanProvider planProvider) {
    ...
    public BaseResponse<List<GetPlanetsRes>> getPlanets(
        @PathVariable("journey_id") int journey_id) {
    ...
    public BaseResponse<GetDetailedInfoRes> getDetailedInfo(
    ...
    public BaseResponse<PostNewPlanetRes> createNewPlanet(
        @PathVariable("journey_id") int journey_id,
        @RequestBody PostNewPlanetReq postNewPlanetReq) {
